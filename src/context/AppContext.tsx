...
export const ROLE_PROFILES: Record<UserRole, UserProfile> = {
  CITIZEN: {
    name: 'Ramesh Patel',
    role: 'CITIZEN',
    roleTitle: 'Citizen / Landholder',
    department: 'Registered Citizen Services',
    badgeLabel: 'Citizen',
    avatarInitials: 'RP',
    location: 'Krishnapuram, Hoskote',
  },
  OFFICER: {
    name: 'Officer K. Sharma',
    role: 'OFFICER',
    roleTitle: 'Digitization & Verification Officer',
    department: 'Directorate of Land Records & Survey',
    badgeLabel: 'Digitization Officer',
    avatarInitials: 'KS',
    location: 'District Survey Division, Bengaluru',
  },
  HIGH_AUTHORITY: {
    name: 'Dr. V. Narayanan',
    role: 'HIGH_AUTHORITY',
    roleTitle: 'Sub-Registrar & Revenue Divisional Officer',
    department: 'Department of Revenue Administration',
    badgeLabel: 'Final Approving Authority',
    avatarInitials: 'VN',
    location: 'Divisional Revenue Secretariat',
  },
};
